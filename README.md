⚠️ ATTENTION : Il est très important d'importer sur le dossier télécharger votre bot (En gros mettre vos fichiers sur le bot template). Et ne pas faire l'inverse. Sinon sa ne marchera pas ! ⚠️

Bien le bonjour.

Bot développer en Discord.js V14.
...
-> Ensuite ouvrez un terminal sur le dossier installer.
